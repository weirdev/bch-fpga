...
HD_PWD='H:/Documents/andor/andor.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log andxor.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source andxor.tcl -notrace
